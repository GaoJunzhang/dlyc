package com.zgj.sb.sbstatic.service;

import com.alibaba.fastjson.JSONObject;
import com.zgj.sb.sbstatic.model.AccessTokenResponse;
import com.zgj.sb.sbstatic.model.TicketResponse;
import com.zgj.sb.sbstatic.model.WxConfig;
import com.zgj.sb.sbstatic.model.WxRequest;
import com.zgj.sb.sbstatic.util.CheckUtils;
import com.zgj.sb.sbstatic.util.WxUtils;
...
public class WxServiceImpl implements WxService {
    ...
    private static final String JSAPI_TICKET_CACHE_KEY = "jsapi:ticket";
    /**
    ...
    private String getTicket(String accessToken) {
        // 这个url链接和参数不能变
        String jsapiTicket = redisTemplate.opsForValue().get(JSAPI_TICKET_CACHE_KEY);
        ...
        jsapiTicket = ticketResponse.getTicket();
        if (!StringUtils.isEmpty(jsapiTicket)){
            redisTemplate.opsForValue().set(JSAPI_TICKET_CACHE_KEY,jsapiTicket,EXPIRE,TimeUnit.MILLISECONDS);
        }
        return jsapiTicket;
    }
